			...
			$t = function() {
				! function(e) {
					...
					if (ae(ut.element, "children", []).length < 1) {
						...
						p.setAttribute("src", "https://tcr9i.chat.openai.com/v2/1.5.5/enforcement.fbfc14b0d793c6ef8359e0e4b4a91f67.html#3D86FBBA-9D22-402A-B512-3420086BA6CC"), p.setAttribute("class", s), p.setAttribute("title", l), p.setAttribute("aria-label", l), p.setAttribute("data-e2e", "enforcement-frame"), p.style.width = "0px", p.style.height = "0px", p.addEventListener("load", (function() {
							c.subTimerEnd(M, z)
