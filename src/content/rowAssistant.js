...
function rowAssistant(
  ...
  const avatarColor =
    modelSlug?.includes('plugins') || modelSlug?.startsWith('gpt-4')
      ? 'rgb(171, 104, 255)'
      : 'rgb(25, 195, 125)';
  ...
  class="w-full border-b border-black/10 dark:border-gray-900/50 text-gray-800 dark:text-gray-100 group ${
    pinned ? 'border-l-pinned bg-pinned dark:bg-pinned' : 'bg-gray-50 dark:bg-[#444654]'
  }">
  ...
  }" style="background-color: transparent; border: none; cursor: pointer;width: 18px; position: absolute; top: -8px; right: 6px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="${
    pinned ? 'gold' : '#aaa'
