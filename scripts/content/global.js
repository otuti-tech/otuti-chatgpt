/* global markdownit, hljs, getAccount, */
...
function initializeStorage() {
  ...
  return chrome.storage.local.get(['customModels', 'conversations']).then((result) => chrome.storage.local.set({
...
function addScrollButtons() {
  const observer = new MutationObserver(() => {
    ...
    scrollButtonWrapper.classList = 'absolute flex items-center justify-center bg-gray-100 dark:bg-gray-700 text-gray-200 text-xs font-sans cursor-pointer rounded-md z-10';
    ...
    scrollUpButton.classList = 'flex items-center justify-center border-black/10 dark:border-gray-900/50 text-gray-800 dark:text-gray-100 hover:bg-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-900 dark:hover:text-gray-200 text-xs font-sans cursor-pointer rounded-t-md z-10';
    ...
    scrollDownButton.classList = 'flex items-center justify-center border-black/10 dark:border-gray-900/50 text-gray-800 dark:text-gray-100 hover:bg-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-900 dark:hover:text-gray-200 text-xs font-sans cursor-pointer rounded-b-md z-10';
...
function addAutoSyncToggleButton() {
  ...
  autoSyncToggleButton.classList = 'absolute flex items-center justify-center bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-100 hover:bg-gray-300 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-900 dark:hover:text-gray-200 text-xs font-sans cursor-pointer rounded-md z-10';
