...
function addNewsletterButton() {
  ...
  newsletterButton.classList = 'flex relative py-3 px-3 items-center gap-3 rounded-md hover:bg-token-sidebar-surface-secondary transition-colors duration-200 text-token-text-primary cursor-pointer text-sm';
