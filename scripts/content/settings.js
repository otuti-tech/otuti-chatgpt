...
function modelsTabContent(hasSubscription = false) {
  ...
  chrome.storage.local.get(['settings', 'models', 'unofficialModels', 'customModels', 'selectedModel'], (result) => {
    ...
    unofficialNote.innerHTML = 'Custom models are experimental. They may or may not work. This feature was implemented to make it easy to test other models. <a href="https://www.youtube.com/watch?v=laRDIUkedz8&ab_channel=Superpower" target="_blank" class="underline text-gold" rel="noreferrer">Learn more</a>';
