...
//   if (null == a) throw Error("Failed to get 2d context for mask canvas");
//   let r = a.createImageData(e.width, e.height);
//   for (let t = 0; t < e.data.length; t += 4)
//     0 !== e.data[t + 3]
//       ? ((r.data[t] = 0), (r.data[t + 1] = 0), (r.data[t + 2] = 0))
//       : ((r.data[t] = 255), (r.data[t + 1] = 255), (r.data[t + 2] = 255)),
//       (r.data[t + 3] = 255);
//   return a.putImageData(r, 0, 0), y(n, t);
// }
function openDalleEditor(image) {
  ...
  const dalleEditor = document.createElement('div');
  dalleEditor.id = 'dalle-editor';
  dalleEditor.classList = 'flex items-center justify-center bg-black/90 backdrop-blur-xl';
  dalleEditor.style.width = '60%';
  dalleEditor.appendChild(canvas);

  const main = document.querySelector('main');
  main.classList.add('flex');
  main.prepend(dalleEditor);
