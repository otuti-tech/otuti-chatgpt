...
function getGalleryImageSrc(imageId) {
  getDownloadUrlFromFileId(imageId).then((response) => {
    ...
    if (selectImageElement && selectedGalleryImage?.imageId === imageId) {
