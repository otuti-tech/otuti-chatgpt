/* global modelSwitcher, dropdown, addDropdownEventListener, languageList, writingStyleList, toneList, addModelSwitcherEventListener, gizmoMenu, addGizmoMenuEventListeners, addUploadFileButton, getGizmoById, getGizmoIdFromUrl */
function addNavbar(conversation = null) {
  ...
  chrome.storage.local.get(['settings', 'models', 'selectedModel', 'unofficialModels', 'customModels'], (result) => {
    const {
      models, selectedModel, settings, unofficialModels, customModels,
    } = result;
    const {
