...
function gizmoMenu(gizmoData, currentUserId, side = 'left', forceDark = false) {
  ...
  return `<div style="left:12px;height:46px;z-index:100;width:100%;"><button id="gizmo-menu" class="relative w-full h-full flex items-center cursor-pointer rounded-md border border-token-border-light bg-token-main-surface-secondary p-2 text-center focus:border-green-600 focus:outline-none focus:ring-1 focus:ring-green-600 sm:text-sm" type="button">
...
<ul id="gizmo-menu-options" style="max-height:400px;width:250px;" class="hidden transition-all absolute z-10 ${side === 'right' ? 'right-0' : 'left-0'} mt-1 overflow-auto rounded-md p-1 text-base ring-1 ring-opacity-5 focus:outline-none ${forceDark ? 'ring-white/20 last:border-0' : ''} bg-token-main-surface-secondary dark:ring-white/20 dark:last:border-0 sm:text-sm -translate-x-1/4" role="menu" aria-orientation="vertical" tabindex="-1">

  <li class="flex text-token-text-primary py-2 relative cursor-pointer select-none border-b py-1 pl-3 pr-9 last:border-0 border-token-border-light hover:bg-token-main-surface-tertiary" id="gizmo-menu-option-new-chat" role="option" tabindex="-1">
  ...
  <li class="flex text-token-text-primary py-2 relative cursor-pointer select-none border-b py-1 pl-3 pr-9 last:border-0 border-token-border-light hover:bg-token-main-surface-tertiary" id="gizmo-menu-option-about" role="option" tabindex="-1">
  ...
  ${gizmoAction ? `<li class="flex text-token-text-primary py-2 relative cursor-pointer select-none border-b py-1 pl-3 pr-9 last:border-0 border-token-border-light hover:bg-token-main-surface-tertiary" id="gizmo-menu-option-privacy-settings" role="option" tabindex="-1">
  ...
  ${authorId === currentUserId ? `<li class="flex text-token-text-primary py-2 relative cursor-pointer select-none border-b py-1 pl-3 pr-9 last:border-0 border-token-border-light hover:bg-token-main-surface-tertiary" id="gizmo-menu-option-edit-gpt" role="option" tabindex="-1">
  ...
  ${isPublic && false ? `<li class="flex text-token-text-primary py-2 relative cursor-pointer select-none border-b py-1 pl-3 pr-9 last:border-0 border-token-border-light hover:bg-token-main-surface-tertiary" id="gizmo-menu-option-report" role="option" tabindex="-1">
...
function showGizmoAboutDialog(gizmoResource) {
  ...
  <div data-state="open" class="fixed inset-0 bg-black/50 dark:bg-gray-600/70" style="pointer-events: auto;">
    <div class="grid-cols-[10px_1fr_10px] grid h-full w-full grid-rows-[minmax(10px,_1fr)_auto_minmax(10px,_1fr)] md:grid-rows-[minmax(20px,_1fr)_auto_minmax(20px,_1fr)] overflow-y-auto">
      <div id="gizmo-about-dialog-content" role="dialog" id="radix-:rof:" aria-describedby="radix-:roh:" aria-labelledby="radix-:rog:" data-state="open" class="relative col-auto col-start-2 row-auto row-start-2 w-full rounded-xl text-left shadow-xl transition-all left-1/2 -translate-x-1/2 bg-token-main-surface-secondary max-w-xl" tabindex="-1" style="pointer-events: auto;">
        <div class="px-4 pb-4 pt-5 sm:p-6 flex items-center justify-between">
          <div class="flex">
            <div class="flex items-center">
              <div class="flex grow flex-col gap-1">
                <h2 id="radix-:rog:" as="h3" class="text-lg font-medium leading-6 text-token-text-primary"></h2>
              </div>
            </div>
          </div>
          <button id="gizmo-about-close-button" class="text-token-text-tertiary transition hover:text-gray-700 dark:hover:text-gray-200">
        ...
        <div class="">
          <div class="flex flex-col gap-4 px-6 pb-10">
            <div class="flex h-full flex-col items-center justify-center">
              <div class="relative">
                <div class="mb-3 h-12 w-12">
                  <div class="gizmo-shadow-stroke overflow-hidden rounded-full">
                    <img src="${gizmoResource.gizmo.display.profile_picture_url}" class="h-full w-full bg-token-main-surface-secondary dark:bg-token-main-surface-tertiary" alt="GPT" width="80" height="80">
                  </div>
                </div>
              </div>
              <div class="flex flex-col items-center gap-2">
                ...
                <div class="flex items-center gap-1 text-token-text-tertiary">
                  ...
                  <span title="${creatorTooltipName} can't view your chats" class="pt-[1px]" data-state="closed">
            ...
            <div class="flex justify-center">
              <div class="flex flex-col items-center gap-2 border-l border-token-border-heavy first:border-0 w-48 mt-4">
                <div class="flex flex-row items-center gap-1.5 pt-1 text-xl font-medium">${gizmoResource.gizmo?.vanity_metrics?.num_conversations_str}</div>
                <div class="text-xs text-token-text-tertiary">conversations</div>
              </div>
            </div>
            <div class="flex flex-col">
              <div class="font-bold mt-6 mb-2">Capabilities</div> ${uniqueToole.map((tool) => `<div class="flex flex-row items-start gap-2 py-1 text-sm">
